...
async function renderTable() {
  ...
  try {
    ...
    querySnapshot.forEach((doc) => {
      ...
      data.profileImg =
        data.profileImg || "https://placehold.co/128x128/ddd/ddd";
...
function createTableRow(index, data) {
  ...
  const cellContents = [
    index,
    `<img src="${data.profileImg}" class="profile-img" alt="${data.name} Profile Image" onError="this.src=https://placehold.co/128x128/ddd/ddd">`,
    data.name,
    data.email,
    data.phone,
