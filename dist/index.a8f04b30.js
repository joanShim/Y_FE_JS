...
registerButton.addEventListener("click", async ()=>{
    try {
        const newDocRef = await (0, _firestore.addDoc)((0, _firestore.collection)(db, "database"), {}); // 빈 문서 생성
        ...
        (0, _firestore.updateDoc)(newDocRef, data).then(()=>{
...
document.addEventListener("click", async (event)=>{
    if (event.target.id === "btn-delete") {
        ...
        if (confirmDelete) try {
            const docRef = (0, _firestore.doc)(db, "database", docId);
...
},{"firebase/app":"aM3Fo","dotenv":"lErsX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","/node_modules/@firebase/storage":"jEcdO","/node_modules/@firebase/firestore":"fkIBe"}]},["fTqHN","5AKj5"], "5AKj5", "parcelRequire8d1c")
